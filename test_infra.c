...
union sui64_fp64 fp64_special_values[N_SPECIALS] = {
  ...
  (int64_t) 0xffefffffffffffff,
  (int64_t) 0xbff0000000000000,
  (int64_t) 0x8010000000000000,
  (int64_t) 0x800fffffffffffff,
  (int64_t) 0x8000000000000001,
  (int64_t) 0x8000000000000000,
  (int64_t) 0x0000000000000000,
  (int64_t) 0x0000000000000001,
  (int64_t) 0x000fffffffffffff,
  (int64_t) 0x0010000000000000,
  (int64_t) 0x3ff0000000000000,
  (int64_t) 0xbff0000000000000,
  (int64_t) 0x7fefffffffffffff,
  (int64_t) 0x7ff0000000000000,
  (int64_t) 0x7ff4000000000000,
...
void report_err_powD_fp64(
  ...
  for (int j = 0; j < nb_pts; j++) {
    ...
    if (VERBOSE) {
      ...
      yyy.f = y[j];
      zzz.f = z[j];
      printf("--input %24.17le, 0x%016lx; %24.17le, 0x%016lx, output %24.17le, 0x%016lx \n",
...
void show_special2_fp64(
  ...
  double x[N_SPECIALS*N_SPECIALS], y[N_SPECIALS*N_SPECIALS], z[N_SPECIALS * N_SPECIALS];
  union sui64_fp64 xxx, yyy, zzz;
